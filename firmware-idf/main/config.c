...
void cfg_load(aidlink_cfg_t *c) {
    ...
    strcpy(c->ap_ip, "172.20.1.1");
    strcpy(c->ap_mask, "255.255.255.192");
    strcpy(c->ap_lease, "172.20.1.2");
    c->ap_lease_min = 120; c->ap_dhcp_count = 60;
    ...
    get_str(h, "ap_ip", c->ap_ip, sizeof c->ap_ip);
    get_str(h, "ap_mask", c->ap_mask, sizeof c->ap_mask);
    get_str(h, "ap_lease", c->ap_lease, sizeof c->ap_lease);
    c->ap_lease_min = get_u16(h, "ap_lease_min", c->ap_lease_min);
    c->ap_dhcp_count = get_i32(h, "ap_dhcp_count", c->ap_dhcp_count);
    c->ap_channel = get_i32(h, "ap_channel", c->ap_channel);
    c->ap_max_clients = get_i32(h, "ap_max_clients", c->ap_max_clients);
...
int cfg_save(const aidlink_cfg_t *c) {
    ...
    e |= nvs_set_str(h, "ap_ip", c->ap_ip);
    e |= nvs_set_str(h, "ap_mask", c->ap_mask);
    e |= nvs_set_str(h, "ap_lease", c->ap_lease);
    e |= nvs_set_u16(h, "ap_lease_min", c->ap_lease_min);
    e |= nvs_set_i32(h, "ap_dhcp_count", c->ap_dhcp_count);
    e |= nvs_set_i32(h, "ap_channel", c->ap_channel);
    e |= nvs_set_i32(h, "ap_max_clients", c->ap_max_clients);
